...
export default function NextPageArrowIcon({ onPress, color }) {
  return (
    <Pressable onPress={onPress} style={{ width: 15 }}>
      <Svg
        version="1.0"
      ...
      >
        <G
          transform="translate(0.000000,176.000000) scale(-0.100000,-0.100000) translate(-1760,0)"
          fill={color}
          stroke="none"
        >
          <Path
